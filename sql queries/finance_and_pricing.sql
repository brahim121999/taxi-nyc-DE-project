-- How does the total fare revenue of yellow taxis change over time?
...
-- What is the average fare per trip, and how does it vary by borough, time of day and trip distance?
...
-- What is the proportion of different payment types (credit card, cash, etc.) and has it changed over time?
...
-- How often do passengers tip, and what factors (time of day, borough, fare amount) influence tip amounts?
...
-- How much revenue is generated from additional charges (MTA tax, congestion surcharge, airport fees) and has it changed over time?
