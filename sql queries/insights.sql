-- Which boroughs or zones have the highest and lowest trip volumes and how do they compare over time?
...
-- How frequently do yellow taxis serve airports (JFK, LaGuardia, ..) and what is the average fare for these trips?
...
-- How often do taxis use different rate codes (standard rate vs negotiated fares, ..) and how do these rates vary across boroughs?
...
-- How long do trips typically take, and is there a trend of increasing or decreasing trip durations over time?
