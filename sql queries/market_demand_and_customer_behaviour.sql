-- How does the demand for yellow taxis fluctuate over time (daily, weekly, monthly and seasonally)?
...
FROM `taxi-project-461423.transformed_data.cleaned_and_filtered`
...
-- What are the peak hours for yellow taxi trips in different boroughs and zones?
...
SELECT
    ...
    z.Zone,
    COUNT(*) AS total_trips
FROM `taxi-project-461423.transformed_data.cleaned_and_filtered` t
JOIN `taxi-project-461423.taxitrips.taxi_zone` z
...
-- What are the most popular pickup and drop-off locations and how do they change over time?
...
SELECT
    ...
    COUNT(*) AS total_trips
FROM `taxi-project-461423.transformed_data.cleaned_and_filtered` t
JOIN `taxi-project-461423.taxitrips.taxi_zone` pz
    ON t.PULocationID = pz.LocationID
JOIN `taxi-project-461423.taxitrips.taxi_zone` dz
...
-- What is the average trip distance and how does it vary by borough, time of day and season?
...
-- How many trips have only one passenger versus multiple passengers and does this change seasonally?
